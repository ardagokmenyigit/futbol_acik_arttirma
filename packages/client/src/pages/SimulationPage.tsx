...
const DEFAULT_DEMO_SQUADS: Record<string, Footballer[]> = {
  'user-1': [
    { id: 'u1-1', name: 'Thibaut Courtois', position: 'GK', overall: 89 },
    { id: 'u1-2', name: 'Antonio Rüdiger', position: 'DEF', overall: 86 },
    { id: 'u1-3', name: 'Dani Carvajal', position: 'DEF', overall: 85 },
    { id: 'u1-4', name: 'Jude Bellingham', position: 'MID', overall: 90 },
    {
      id: 'u1-5',
    ...
    { id: 'u1-6', name: 'Vinícius Jr.', position: 'FWD', overall: 90 },
    { id: 'u1-7', name: 'Kylian Mbappé', position: 'FWD', overall: 91 },
  ],
  'user-2': [
    { id: 'u2-1', name: 'Ederson', position: 'GK', overall: 88 },
    { id: 'u2-2', name: 'Rúben Dias', position: 'DEF', overall: 88 },
    { id: 'u2-3', name: 'Joško Gvardiol', position: 'DEF', overall: 84 },
    { id: 'u2-4', name: 'Rodri', position: 'MID', overall: 91 },
    { id: 'u2-5', name: 'Kevin De Bruyne', position: 'MID', overall: 90 },
    { id: 'u2-6', name: 'Phil Foden', position: 'FWD', overall: 88 },
    { id: 'u2-7', name: 'Erling Haaland', position: 'FWD', overall: 91 },
  ],
  'bot-1': [
    { id: 'b1-1', name: 'Manuel Neuer', position: 'GK', overall: 87 },
    { id: 'b1-2', name: 'Dayot Upamecano', position: 'DEF', overall: 82 },
    { id: 'b1-3', name: 'Alphonso Davies', position: 'DEF', overall: 82 },
    { id: 'b1-4', name: 'Joshua Kimmich', position: 'MID', overall: 86 },
    { id: 'b1-5', name: 'Jamal Musiala', position: 'MID', overall: 87 },
    { id: 'b1-6', name: 'Leroy Sané', position: 'FWD', overall: 85 },
    { id: 'b1-7', name: 'Harry Kane', position: 'FWD', overall: 90 },
  ],
  'bot-2': [
    { id: 'b2-1', name: 'David Raya', position: 'GK', overall: 84 },
    { id: 'b2-2', name: 'William Saliba', position: 'DEF', overall: 87 },
    {
      id: 'b2-3',
    ...
    { id: 'b2-4', name: 'Declan Rice', position: 'MID', overall: 87 },
    { id: 'b2-5', name: 'Martin Ødegaard', position: 'MID', overall: 89 },
    {
      id: 'b2-6',
    ...
    { id: 'b2-7', name: 'Bukayo Saka', position: 'FWD', overall: 87 },
  ],
  'bot-3': [
    { id: 'b3-1', name: 'Yann Sommer', position: 'GK', overall: 87 },
    {
      id: 'b3-2',
    ...
    { id: 'b3-3', name: 'Federico Dimarco', position: 'DEF', overall: 83 },
    { id: 'b3-4', name: 'Nicolò Barella', position: 'MID', overall: 87 },
    { id: 'b3-5', name: 'Hakan Çalhanoğlu', position: 'MID', overall: 86 },
    { id: 'b3-6', name: 'Marcus Thuram', position: 'FWD', overall: 84 },
    { id: 'b3-7', name: 'Lautaro Martínez', position: 'FWD', overall: 89 },
  ],
  'bot-4': [
    {
      id: 'b4-1',
    ...
    { id: 'b4-2', name: 'Marquinhos', position: 'DEF', overall: 87 },
    { id: 'b4-3', name: 'Achraf Hakimi', position: 'DEF', overall: 84 },
    { id: 'b4-4', name: 'Vitinha', position: 'MID', overall: 85 },
    {
      id: 'b4-5',
    ...
    { id: 'b4-6', name: 'Bradley Barcola', position: 'FWD', overall: 82 },
    { id: 'b4-7', name: 'Ousmane Dembélé', position: 'FWD', overall: 86 },
  ],
  'bot-5': [
    {
      id: 'b5-1',
    ...
    { id: 'b5-2', name: 'Ronald Araújo', position: 'DEF', overall: 86 },
    { id: 'b5-3', name: 'Jules Koundé', position: 'DEF', overall: 85 },
    { id: 'b5-4', name: 'Pedri', position: 'MID', overall: 86 },
    { id: 'b5-5', name: 'Dani Olmo', position: 'MID', overall: 84 },
    { id: 'b5-6', name: 'Lamine Yamal', position: 'FWD', overall: 85 },
    {
      id: 'b5-7',
  ...
  'bot-6': [
    { id: 'b6-1', name: 'Lukáš Hrádecký', position: 'GK', overall: 84 },
    { id: 'b6-2', name: 'Jonathan Tah', position: 'DEF', overall: 86 },
    { id: 'b6-3', name: 'Jeremie Frimpong', position: 'DEF', overall: 84 },
    { id: 'b6-4', name: 'Granit Xhaka', position: 'MID', overall: 86 },
    { id: 'b6-5', name: 'Florian Wirtz', position: 'MID', overall: 88 },
    { id: 'b6-6', name: 'Victor Boniface', position: 'FWD', overall: 82 },
    {
      id: 'b6-7',
